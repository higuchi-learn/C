...
#include <stdio.h>
#include <math.h>
#define EULER 0.577215664901532860606512090082  /* Euler‚Ì’è” $\gamma$ */

static double Ci_series(double x)  /* ‹‰”“WŠJ */
{
    int k;
    double s, t, u;
    ...
    printf("Si_series(): û‘©‚µ‚Ü‚¹‚ñ.\n");
    return s;
}

double Ci_asympt(double x)  /* ‘Q‹ß“WŠJ */
{
    int k, flag;
